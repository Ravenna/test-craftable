...
/* Auto-generated admin routes */
Route::middleware(['auth:' . config('admin-auth.defaults.guard'), 'admin'])->group(function () {
    Route::get('/admin/buildings',                              'Admin\BuildingsController@index');
    Route::get('/admin/buildings/create',                       'Admin\BuildingsController@create');
    Route::post('/admin/buildings',                             'Admin\BuildingsController@store');
    Route::get('/admin/buildings/{building}/edit',              'Admin\BuildingsController@edit')->name('admin/buildings/edit');
    Route::post('/admin/buildings/{building}',                  'Admin\BuildingsController@update')->name('admin/buildings/update');
    Route::delete('/admin/buildings/{building}',                'Admin\BuildingsController@destroy')->name('admin/buildings/destroy');
});